		...
		<div class="body-container row justify-content-center">
			<div class="col-md-10 my-3 p-3">
				<div class="body-title">
					<h3 class="section-title"><i class="bi bi-shield-lock-fill text-secondary"></i> 자유게시판 - 공지</h3>
				...
				<div class="body-main board-list-wrapper">
						...
						<tbody>
							<c:forEach var="dto" items="${list}" varStatus="status">
								<tr>
									...
									<td class="left">
										<div class="text-wrap">
											<c:url var="articleLink" value="/admin/bbs/article">
											    <c:param name="num" value="${dto.num}" />
											    <c:param name="categoryNum" value="1" /> <!-- 글의 카테고리 -->
    											<c:param name="listCategoryNum" value="1" /> <!-- 리스트에서 선택한 카테고리 -->
					...
					<div class="row board-list-footer">
						<div class="col">
							<button type="button" class="btn btn-light" onclick="location.href='${pageContext.request.contextPath}/admin/bbs/list?categoryNum=1';" title="새로고침"><i class="bi bi-arrow-counterclockwise"></i></button>
						</div>
						...
						<div class="col text-end">
							<c:if test="${sessionScope.member.userLevel >= 1}">
								<button type="button" class="btn btn-light" onclick="location.href='${pageContext.request.contextPath}/admin/bbs/write';">글올리기</button>
							</c:if>
						</div>
					</div>
				</div>
...
function searchList() {
	...
	let url = '${pageContext.request.contextPath}/admin/bbs/list';
