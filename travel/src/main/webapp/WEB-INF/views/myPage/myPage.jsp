		...
		<div class="body-container">
		    ...
		    <div class="body-title row col-10">
		    	<div class="body-title col">
					<h3><i class="fa-solid fa-house"></i> 마이페이지 </h3>
				</div>
				<div class="row">
						...
						<div class="card border-0">
							<div class="card-body p-3">
								<h5 class="card-title mb-3">
									<i class="fa-solid fa-address-card me-2" style="color: rgb(13, 110, 253);"></i>기본 정보
								</h5>
								...
								<div class="small mb-2 d-flex ">
									전화번호: ${sessionScope.member.tel}
								</div>
								<div class="small mb-2 d-flex ">
									가입일: ${sessionScope.member.register_date}
								</div>
							</div>
						</div>
					</div>
			...
			<div class="body-main">
				<div class="body-title row col-10">
					<div class="col">
						<div class="mb-4">
							<h3><i class="fa-solid fa-calendar-days	"></i> 나의 일정 </h3>
						</div>
						<div>
							<div class="mt-5"> <!-- 여기로 공간 확보 -->
							  <div id="scheduleCarousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="7000">
							    <div class="carousel-inner">
									<c:forEach var="i" begin="0" end="${listSchedule.size() - 1}" step="5" varStatus="groupStatus">
										<div class="carousel-item ${groupStatus.index == 0 ? 'active' : ''}">
											<div class="row g-4 px-3 justify-content-center">
												<c:forEach var="j" begin="0" end="4">
													<c:if test="${i + j < listSchedule.size()}">
														<div class="card h-100 shadow-sm mx-2" style="max-width: 200px;">
															<div class="card-body">
																<h6 class="card-title text-truncate">
																	제목: <a href="${pageContext.request.contextPath}/myPage/schedule/main" class="text-decoration-none text-dark"> ${listSchedule[i + j].subject} </a>
																</h6>
							...
							<div class="pt-2 text-end">
								<a href="${pageContext.request.contextPath}/myPage/schedule/main" class="text-reset">더보기</a>
							</div>
						</div>
					</div>
				</div>	
			...
			<div class="body-main">
				<div class="body-title row col-10">
					<div class="col">
						<div>
							<h3><i class="fa-solid fa-star"></i> 즐겨찾기 목록 </h3>
						</div>
						<div>
							<div class="border px-2 mt-1">
								<c:forEach var="dto" items="${listBoard}">
								<div class="text-truncate px-2 subject-list">
									<a href="${pageContext.request.contextPath}/myPage/scrap?page=1&num=${dto.num}">${dto.subject}</a>								
								</div>
								</c:forEach>
							...
							<div class="pt-2 text-end">
								<a href="${pageContext.request.contextPath}/myPage/scrap" class="text-reset">더보기</a>
							</div>
						</div>
					</div>
				</div>	
