...
// 게시물 리스트
	@RequestMapping(value = "/admin/bbs/list", method = RequestMethod.GET)
	public ModelAndView list(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		ModelAndView mav = new ModelAndView("/admin/bbs/list");
		...
		try {
	        ...
	        if (kwd.length() == 0) {
	            ...
	            dataCount = dao.dataCount(1, schType, kwd);
	        }
	        ...
	        List<BoardDTO> list;
	        if (kwd.length() == 0) {
	            list = dao.listBoard(offset, size, 1);
	        } else {
	            list = dao.listBoard(1, offset, size, schType, kwd);
	        }
	        ...
	        String listUrl = cp + "/admin/bbs/list?categoryNum=1";
	        String articleUrl = cp + "/admin/bbs/article?categoryNum=1&page=" + current_page;
	        if (query.length() != 0) {
	            listUrl += "&" + query;
	            articleUrl += "&" + query;
	        }
	...
	@RequestMapping(value = "/admin/bbs/write", method = RequestMethod.GET)
	public ModelAndView writeForm(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
	    ...
	    ModelAndView mav = new ModelAndView("/admin/bbs/write");
	    mav.addObject("categoryNum", 1);
	...
	@RequestMapping(value = "/admin/bbs/write", method = RequestMethod.POST)
	public ModelAndView writeSubmit(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		return new ModelAndView("redirect:/admin/bbs/list?categoryNum=1");
	}

	@RequestMapping(value = "/admin/bbs/article", method = RequestMethod.GET)
	public ModelAndView article(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			if (listCategoryNum == null || listCategoryNum.isEmpty()) {
			    listCategoryNum = "1"; // 기본값 설정 (전체 보기 등)
			}
			
			String page = req.getParameter("page");
			String query = "categoryNum=1&page=" + page;
			...
			if(dto == null) {
				return new ModelAndView("redirect:/admin/bbs/list?" + query);
			}
			
			// 이전글/다음글 (조건에 따라 분기)			
			BoardDTO prevDto = dao.findByPrev(1, num, schType, kwd);
			BoardDTO nextDto = dao.findByNext(1, num, schType, kwd);
			...
			// JSP로 전달할 속성
			ModelAndView mav = new ModelAndView("/admin/bbs/article");
			mav.addObject("categoryNum", 1);
			
			
			mav.addObject("dto", dto);
			
			mav.addObject("listCategoryNum", 1); // 리스트로 돌아가기용
			mav.addObject("categoryNum", 1); // 진짜 글의 카테고리
		...
		// 예외 발생 시 목록으로 이동
		return new ModelAndView("redirect:/admin/bbs/list?");
	}
	...
	public ModelAndView updateForm(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			if (dto == null) {
				return new ModelAndView("redirect:/admin/bbs/list?categoryNum=1&page=" + page);
			}
		...
		return new ModelAndView("redirect:/admin/bbs/list?page="+ page);
	}
	...
	@RequestMapping(value = "/admin/bbs/deleteFile")
	public ModelAndView deleteFile(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			if (!info.getUserId().equals(dto.getUserId())) {
				return new ModelAndView("redirect:/bbs/list?categoryNum=1&page=" + page);
			}
	...
	@RequestMapping(value = "/admin/bbs/delete", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/admin/bbs/download")
	...
	// 게시글 공감 저장 - AJAX:JSON
	@ResponseBody
	@RequestMapping(value = "/admin/bbs/insertBoardLike", method = RequestMethod.POST)
	...
	// 리플 리스트 - AJAX:TEXT
	@RequestMapping(value = "/admin/bbs/listReply", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/admin/bbs/listReplyAnswer", method = RequestMethod.GET)
	public ModelAndView listReplyAnswer(HttpServletRequest req, HttpServletResponse resp)
	    ...
	    try {
	        ...
	        ModelAndView mav = new ModelAndView("/admin/bbs/listReplyAnswer");
	...
	// 댓글 숨김/표시 : AJAX-JSON
	@ResponseBody
	@RequestMapping(value = "/admin/bbs/replyShowHide", method = RequestMethod.POST)
